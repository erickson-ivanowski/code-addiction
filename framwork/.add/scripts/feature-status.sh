...
# =============================================================================
# OUTPUT: SKILLS (available in .add/skills/)
# =============================================================================
...
if [ -d "$SKILLS_DIR" ]; then
    ...
    if [ -n "$SKILL_LIST" ]; then
        ...
        echo "SKILLS_PATH:.add/skills/{$SKILL_LIST}/SKILL.md"
    fi
fi

# =============================================================================
# OUTPUT: PROJECT PATTERNS (from .add/project/*.md)
# =============================================================================

PROJECT_DIR=".add/project"
if [ -d "$PROJECT_DIR" ]; then
    ...
    if [ -n "$PROJECT_FILES" ]; then
        ...
        echo "PROJECT_DOCS:.add/project/{$PROJECT_FILES}.md"
    fi
else
