...
| add-hotfix | Correcao urgente dual-mode: fix em feature existente (F[XXXX]) ou standalone (H[XXXX]). Usa template (.add/templates/hotfix-template.md) | backend/frontend conforme area |
