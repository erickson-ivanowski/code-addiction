...
> **DOCUMENTATION STYLE:** Follow standards defined in `.add/skills/documentation-style/SKILL.md`
...
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/context-discovery.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/documentation-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/infrastructure-check.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/security-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/architecture-analyzer.md`
...
- **Capability:** read-write (must write output file)
- **Complexity:** standard
- **Prompt:** Content of skill `.add/skills/audit/data-analyzer.md`
- **Additional context:** Pass content of `context-discovery.md` and `infrastructure-report.md`
...
This command requires the following skills in `.add/skills/audit/`:
