...
IF UX-DESIGN SKILL NOT LOADED:
  ...
  ⛔ DO: Read .add/skills/ux-design/SKILL.md FIRST
...
```bash
cat .add/skills/ux-design/SKILL.md
```
...
Grep pattern="[component]" path=".add/skills/ux-design/shadcn-docs.md"
Grep pattern="[utility]" path=".add/skills/ux-design/tailwind-v3-docs.md"
Grep pattern="[pattern]" path=".add/skills/ux-design/motion-dev-docs.md"
Grep pattern="[chart]" path=".add/skills/ux-design/recharts-docs.md"
Grep pattern="[table]" path=".add/skills/ux-design/tanstack-table-docs.md"
```
...
4. Load .add/skills/ux-design/ux-laws-principles.md
5. Load .add/skills/ux-design/modern-patterns.md
...
5. Load .add/skills/ux-design/shadcn-docs.md
6. Load .add/skills/ux-design/tailwind-v3-docs.md
7. Load .add/skills/ux-design/motion-dev-docs.md
...
**Pre-check:** `cat .add/skills/documentation-style/design.md 2>/dev/null`
...
**Skill:** .add/skills/ux-design/SKILL.md
...
**Skill:** .add/skills/ux-design/SKILL.md (MUST load for implementation)
```
