...
BEFORE designing endpoints, read: `.add/skills/backend-development/SKILL.md`
...
- MUST follow `.add/skills/backend-development/SKILL.md` patterns
...
**MANDATORY:** Load skill BEFORE dispatch: `.add/skills/test-specification/SKILL.md`
...
READ: .add/skills/test-specification/SKILL.md — follow ALL rules.
...
- Backend: `.add/skills/backend-development/SKILL.md`
- Database: `.add/skills/database-development/SKILL.md`
- Frontend (Code): `.add/skills/frontend-development/SKILL.md`
- Frontend (UI): `.add/skills/ux-design/SKILL.md`
