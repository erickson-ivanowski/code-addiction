...
prompt: |
  ...
  - .add/skills/frontend-development/SKILL.md (PRIMARY - types, hooks, state, API)
  - .add/skills/code-review/SKILL.md (validation patterns)
  - .add/skills/ux-design/SKILL.md (if design.md missing or for implementation details)
  ...
  ### 6. Project Patterns Validation (if .add/project/*.md exists for frontend apps)
...
prompt: |
  ...
  ## SKILLS (MANDATORY)
  Read BEFORE reviewing:
  - .add/skills/backend-development/SKILL.md (PRIMARY - Clean Arch, RESTful, IoC/DI, DTOs, CQRS)
  - .add/skills/database-development/SKILL.md (Entities, Migrations, Kysely, Repositories)
  - .add/skills/code-review/SKILL.md (validation patterns, contracts)
  - .add/skills/security-audit/SKILL.md (OWASP, multi-tenancy)
  ...
  **Backend ↔ Frontend Contracts:**
  ...
  ### 8.5. Project Patterns Validation (if .add/project/*.md exists)
  **Backend Patterns (from .add/project/[APP_NAME].md):**
  ...
  **Database Patterns (from .add/project/DATABASE.md):**
  ...
  **Load Delivery Validation Skill:**
  ```bash
  cat .add/skills/delivery-validation/SKILL.md
  ```
...
- **Code Review:** `.add/skills/code-review/SKILL.md`
- **Delivery Validation:** `.add/skills/delivery-validation/SKILL.md`
- **Backend Development:** `.add/skills/backend-development/SKILL.md`
- **Database Development:** `.add/skills/database-development/SKILL.md`
- **Frontend Development:** `.add/skills/frontend-development/SKILL.md`
- **UX Design:** `.add/skills/ux-design/SKILL.md`
- **Security Audit:** `.add/skills/security-audit/SKILL.md`
