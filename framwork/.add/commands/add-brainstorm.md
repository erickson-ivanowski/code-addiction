...
IF USER REQUESTS DOCUMENT:
  ...
  ✅ DO: Use Business Style format (read .add/skills/documentation-style/business.md)
...
**FORMAT:** Use Business Style (`.add/skills/documentation-style/business.md` - section brainstorm/)
